...
{
	if (self->track.type == NAUTILUS_BURN_RECORDER_TRACK_TYPE_DATA) {
		g_free (self->track.contents.data.filename);
	} else if (self->track.type == NAUTILUS_BURN_RECORDER_TRACK_TYPE_AUDIO) {
...
nb_AudioTrack_init(nb_Track *self, PyObject *args, PyObject *kwds)
{
    ...
    self->track.type = NAUTILUS_BURN_RECORDER_TRACK_TYPE_AUDIO;
...
nb_DataTrack_init(nb_Track *self, PyObject *args, PyObject *kwds)
{
    ...
    self->track.type = NAUTILUS_BURN_RECORDER_TRACK_TYPE_DATA;
...
static PyTypeObject nb_AudioTrack_Type = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "nautilusburn.AudioTrack", /*tp_name*/
    sizeof(nb_Track),          /*tp_basicsize*/
    0,                         /*tp_itemsize*/
...
static PyTypeObject nb_DataTrack_Type = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "nautilusburn.DataTrack", /*tp_name*/
    sizeof(nb_Track),          /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)nb_Track_dealloc,                         /*tp_dealloc*/
    0,                         /*tp_print*/
